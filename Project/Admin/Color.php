                                        ...
                                        <div class="white_box mb_30">
                                            <div class="box_header ">
                                                <div class="main-title">
                                                    <h3 class="mb-0" >Table color</h3>
                                                </div>
                                            </div>
                                            <form method="post">
                                                <div class="form-group">
                                                    <label for="txt_color">color Name</label>
                                                    <input required="" type="text" class="form-control" id="txt_color" name="txt_color">
                                                </div>
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><a href="color.php?id=<?php echo $data["color_id"];?>" class="status_btn">Delete</a> 
</td>                                            </tr>
                                            <?php                    
                                              }
